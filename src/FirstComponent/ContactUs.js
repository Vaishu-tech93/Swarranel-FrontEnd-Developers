...
//   return (
//     <>
//       <div class="bg-gray-100 mt-24 flex flex-col lg:flex-row lg:justify-center">   
//         <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mx-4 mt-10 w-full lg:w-2/3">
//           <div class="mb-4">
//             <h2 class="text-2xl md:text-4xl font-black text-gray-900 dark:text-white ">Contact Us</h2><br></br><br/>
//             <label class="block text-gray-700 mb-2" for="username">Your Name (required)</label>
//             <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:shadow-outline dark:border-gray-400 bg-gray-50 dark:bg-black-700 dark:placeholder-black-400 dark:text-black dark:focus:ring-black-500 dark:focus:border-black-500 h-12" id="username" type="text" /><br></br><br/>
//           </div>
//           <div class="mb-6">
//             <label class="block text-gray-700 mb-2" for="email">Your Email (required)</label>
//             <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:shadow-outline dark:border-gray-400 bg-gray-50 dark:bg-black-700 dark:placeholder-black-400 dark:text-black dark:focus:ring-black-500 dark:focus:border-black-500 h-12" id="email" type="email" />
//           </div><br/>
//           <div class="mb-6">
//             <label class="block text-gray-700 mb-2" for="subject">Subject</label>
//             <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:shadow-outline dark:border-gray-400 bg-gray-50 dark:bg-black-700 dark:placeholder-black-400 dark:text-black dark:focus:ring-black-500 dark:focus:border-black-500 h-12" id="subject" type="text" />
//           </div><br/>
//           <div>
//             <label class="block text-gray-700 mb-2" for="message">Your Message</label>
//             <textarea id="message" rows="10" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:shadow-outline dark:border-gray-400 bg-gray-50 dark:bg-black-700 dark:placeholder-black-400 dark:text-black dark:focus:ring-black-500 dark:focus:border-black-500 h-48"></textarea>
//           </div><br></br><br/>
//           <button type="button" class="text-white bg-pink-700 hover:bg-pink-300 focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 mb-2 w-full lg:w-auto">Submit</button>
//         </form>

//         <div class="mt-10 lg:ml-10 lg:mt-20 lg:w-1/3 mx-4 mr-10">
//           <div class="bg-white shadow-md rounded-lg p-6 mb-6">
//             <h1 class="text-2xl md:text-4xl text-gray-900 dark:text-white text-center">VISIT US</h1><br></br>
//             <section>
//               <div class="w-full h-64">
//                 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30252.51183889865!2d73.78206393837242!3d18.593686106869892!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2b91b0dd95daf%3A0xa6cb6e3796a09978!2sPimple%20Saudagar%2C%20Pimpri-Chinchwad%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1724949543027!5m2!1sen!2sin" width="100%" height="100%" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
//               </div>
//             </section>
//           </div>

//           <div class="bg-white shadow-md rounded-lg p-6 mr-10 ">
//             <h1 class="text-2xl md:text-4xl text-gray-900 dark:text-white text-center">OUR ADDRESS</h1><br></br>
//             <div class="flex items-center mb-4">
//               <svg class="h-6 w-6 text-gray-700 dark:text-white" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  
...
//               <svg class="h-6 w-6 mt-3 text-gray-700 dark:text-white" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
//                 <path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" />
//               </svg>
              
//               <p> <Link to="https://outlook.live.com/mail/0/" class="hover:bg-gray-100 md:hover:bg-transparent md:hover:text-pink-700 md:p-0 md:dark:hover:text-pink-500 dark:text-white dark:hover:bg-black-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-black-700 ml-5 ">
//          (123)456-7890 </Link></p>
//             </div>
